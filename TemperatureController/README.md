...
## Context
### The readings of the voltage from the temperature sensor (thermistor) is converted to Celsius temperature. This value is used to map the PWM value of the input voltage for the transistor base. The DC motor voltage supply is 9V and the aim of the project is to proportionally regulate the speed of the motor based on the temperature readings